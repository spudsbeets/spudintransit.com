        ...
        <div className="song-page" id="song-page-3">
            ...
            <div id="props-links">
              <div id="craig-props-div">
                <a href="https://www.craigmillerstudio.com/" target="_blank" className="props-anchors"><img id="craig-image" className="props-image" src="./src/images/craig.png" alt="craig"></img></a>
              ...
              <div id="spencer-props-div">
                <a href="https://spencermartinmusic.com/" target="_blank" className="props-anchors"><img id="spencer-image" className="props-image" src="./src/images/spencer.png" alt="spencer"></img></a>
