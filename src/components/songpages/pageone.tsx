    ...
    return(
        <div className="song-page" id="song-page-1">
            ...
            <div id="release-images-div">
                ...
                <img className="release-image" id="c-flower-mountain" alt="c-flower-mountain" src="/images/cflowermtn.png"></img>
                ...
                <a href="https://open.spotify.com/album/3nDfz40mSeu1JFF44A8ZqQ?si=w5Wf-kvQTq2QawDo52guTg" target="_blank" className="links-anchors"><div id="tuesday-with-gp-div" className="release-divs">
                <img className="release-image" id="tuesday-with-gp" alt="tuesday-with-gp" src="/images/tue-cover.png"></img>
                ...
                <a href="https://open.spotify.com/album/3rIbQZ076SLLuK2C1YeFq9?si=gaqklOT-TXyI4L0MKhYf2w" target="_blank" className="links-anchors"><div id="wednesday-with-gp-div" className="release-divs">
                <img className="release-image" id="wednesday-with-gp" alt="wednesday-with-gp" src="/images/wed-cover.png"></img>
