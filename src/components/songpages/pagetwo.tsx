const SongPageTwo = () => {
    return(
        <div className="song-page" id="song-page-2">
            <h1 className="song-page-header" id="song-page-2-header">links</h1>
            <div id="links-div">
                <a href="https://open.spotify.com/artist/03AURnYMBB9193wqXX8Qto?_authfailed=1&flow_ctx=7c5ca33f-f574-4650-84ba-6a3ce4c52ad5%3A1704161470" target="_blank" className="links-anchors"><img src="./src/images/spotify.png" alt="spotify" id="spotify-image" className="link-images"></img></a>
