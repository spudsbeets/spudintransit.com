...
const SpudsShipWindow = ({ setShowSpudsShipTerminal }: PropsType) => {
  return(
    ...
    <a href="https://github.com/spudsbeets/spuds-ship" target="_blank" className="terminal-links"><button className="terminal-window-button" id="spuds-ship-button">play spuds ship</button></a>
