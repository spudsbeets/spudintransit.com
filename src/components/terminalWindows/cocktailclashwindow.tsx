...
const CocktailClashWindow = ({ setShowCCTerminal }: PropsType) => {
  return(
    ...
    <a href="https://www.cocktail-clash.online" target="_blank" className="terminal-links"><button className="terminal-window-button" id="cocktail-clash-button">play cocktail clash</button></a>
