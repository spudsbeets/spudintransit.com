...
const CocktailClashWindow = ({ setShowCCTerminal }: PropsType) => {
  return(
    ...
    <a href="https://github.com/spudsbeets/cocktail-clash-vite" target="_blank" className="terminal-links"><button className="terminal-window-button" id="cocktail-clash-button">play cocktail clash</button></a>
